...
-- Exportiere Datenbank-Struktur für LogAnalyzer
CREATE DATABASE IF NOT EXISTS `LogAnalyzer` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `LogAnalyzer`;

-- Exportiere Struktur von Tabelle LogAnalyzer.logeintrag
...
-- Exportiere Daten aus Tabelle LogAnalyzer.logeintrag: ~0 rows (ungefähr)

-- Exportiere Struktur von Tabelle LogAnalyzer.logfile
...
-- Exportiere Daten aus Tabelle LogAnalyzer.logfile: ~0 rows (ungefähr)

-- Exportiere Struktur von Tabelle LogAnalyzer.logfile_pattern
...
-- Exportiere Daten aus Tabelle LogAnalyzer.logfile_pattern: ~0 rows (ungefähr)

-- Exportiere Struktur von Tabelle LogAnalyzer.passwort
CREATE TABLE IF NOT EXISTS `passwort` (
  `passwort` varchar(100) NOT NULL,
  `datum_geandert` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Exportiere Daten aus Tabelle LogAnalyzer.passwort: ~0 rows (ungefähr)

-- Exportiere Struktur von Tabelle LogAnalyzer.pattern
...
-- Exportiere Daten aus Tabelle LogAnalyzer.pattern: ~0 rows (ungefähr)
